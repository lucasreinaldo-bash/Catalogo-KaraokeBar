...
class RedesSociaisViewController: UIViewController  {
    ...
    override func viewDidLoad() {
        ...
        btnInstagram.addTarget(self, action: #selector(instagram), for: .touchUpInside)
        
         btnFacebook.addTarget(self, action: #selector(facebook), for: .touchUpInside)
        
         btnYoutube.addTarget(self, action: #selector(youtube), for: .touchUpInside)
